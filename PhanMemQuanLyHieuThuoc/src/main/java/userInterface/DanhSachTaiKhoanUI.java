...
public class DanhSachTaiKhoanUI extends JPanel implements ActionListener{
...
private JPanel taoPanelTimKiem() {
	...
	// Tìm Mã nhân viên
	JLabel lblTimMaNV = new JLabel("Tên đăng nhập");
...
private JPanel taoPanelDanhSachNV() {
	...
	String[] headers = {"Tên đăng nhập", "Trạng thái", };  // Tiêu đề cột của bảng
